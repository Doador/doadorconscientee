...
if pagina == "Doações":
    ...
    st.write("""O Dia Mundial da Doação de Órgãos é celebrado anualmente no dia 14 de outubro. Essa data tem como objetivo aumentar a conscientização sobre a importância da doação de órgãos e tecidos, promovendo a solidariedade e o ato de salvar vidas.""")
